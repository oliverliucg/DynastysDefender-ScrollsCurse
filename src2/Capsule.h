...
public:
	...
	// Draw the capsule. colorRenderer is used to draw the rectangle and circleRenderer is used to draw the semicircles.
	void Draw(std::shared_ptr<ColorRenderer> colorRenderer, std::shared_ptr<CircleRenderer> circleRenderer);

	// Draw the outline of the capsule. ColorRenderer is used to draw the rectangle's outline and CircleRenderer is used to draw the semicircles.
	void DrawOutline(std::shared_ptr<ColorRenderer> colorRenderer, std::shared_ptr<CircleRenderer> circleRenderer);
private: 
	glm::vec2 center;
