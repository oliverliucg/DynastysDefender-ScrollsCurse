...
public:
	Scroll(glm::vec2 center, glm::vec2 rollerSize, glm::vec2 silkSize, Texture2D rollerTexture);
	~Scroll();
...
private:
	...
	// Users are not allowed to reset the position of the scroll via this function.
