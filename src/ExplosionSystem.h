...
public:
    ...
    // Create explosion 
    void CreateExplosion(glm::vec2 center, glm::vec4 color, int numParticles, float explosionPointRadiusX = 0.f, float explosionPointRadiusY = -1.f, glm::vec2 scaleRange = glm::vec2(kBubbleRadius / 45.f, kBubbleRadius / 9.f));
    // Create explosions
