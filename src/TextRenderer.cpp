...
std::pair<glm::vec3, bool> TextRenderer::GetTextSize(std::string text,
                                                     float scale,
                                                     float lineWidth,
...
std::pair<float, float> TextRenderer::RenderText(std::string text, float x,
                                                 float y, float scale,
                                                 float lineWidth,
                                                 float lineSpacingFactor,
                                                 float additionalPadding,
...
std::pair<float, float> TextRenderer::RenderCenteredText(
