...
public:
	...
	void SetInterSectionSpacing(const std::string& section1, const std::string& section2, float spacing);
	float GetInterSectionSpacing(const std::string& section1, const std::string& section2) const;
...
private:
	...
	std::unordered_map<std::string, std::unordered_map<std::string, float>> inter_section_spacing_;
	float top_spacing_;
