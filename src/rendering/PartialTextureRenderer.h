...
class PartialTextureRenderer : public Renderer {
 public:
  ...
  void DrawPartialTexture(const Texture2D& texture, glm::vec2 position,
                          glm::vec2 size = glm::vec2(100.0f, 100.0f),
                          glm::vec2 redChannelRange = glm::vec2(0.f, 1.f),
                          glm::vec2 greenChannelRange = glm::vec2(0.f, 1.f),
                          glm::vec2 blueChannelRange = glm::vec2(0.f, 1.f),
