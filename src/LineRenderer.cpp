...
void LineRenderer::DrawLines(const std::vector<glm::vec2>& lines, glm::vec4 color)
{
	...
	glBufferData(GL_ARRAY_BUFFER, lines.size() * sizeof(glm::vec2), lines.data(), GL_STATIC_DRAW);
